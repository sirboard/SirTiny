...
LIBS:ATTinyX16-cache
EELAYER 29 0
EELAYER END
$Descr User 9055 5512
encoding utf-8
Sheet 1 1
Title "ATTiny X16 Development Board "
Date "2020-04-24"
Rev "2"
Comp "SirBoard"
Comment1 "www.SirBoard.com"
Comment2 "ATTiny 416, 816, 1616 and 3217"
Comment3 ""
Comment4 ""
$EndDescr
$Comp
...
RST
Text GLabel 2050 3725 2    50   Input ~ 0
GND
...
PA6
Text GLabel 1225 4525 0    50   Input ~ 0
PA7
Text GLabel 1225 4425 0    50   Input ~ 0
PA6
Text GLabel 1225 3925 0    50   Input ~ 0
PA1
Text GLabel 1225 3825 0    50   Input ~ 0
RST
Text GLabel 1225 4025 0    50   Input ~ 0
PA2
...
Wire Wire Line
	2750 775  2750 1200
Text GLabel 2050 3625 2    50   Input ~ 0
VIN
Text GLabel 1225 3725 0    50   Input ~ 0
VCC
...
U 1 1 5D1949EC
P 6075 1500
F 0 "SW1" H 6075 1650 50  0000 C CNN
F 1 "RST" H 6075 1725 50  0000 C CNN
F 2 "Button_Switch_SMD:SW_SPST_B3U-1000P" H 6075 1500 50  0001 C CNN
...
U 1 1 5EADB1B7
P 5700 1075
F 0 "R6" H 5768 1120 50  0000 L CNN
F 1 "10k" H 5768 1030 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 5740 1065 50  0001 C CNN
F 3 "~" H 5700 1075 50  0001 C CNN
F 4 "C99198" H 5700 1075 50  0001 C CNN "Part"
	1    5700 1075
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 4 "C165981" V 7675 1650 50  0001 C CNN "Part"
	1    7675 1650
	-1   0    0    1   
$EndComp
$Comp
...
F 4 "C165981" V 7675 1400 50  0001 C CNN "Part"
	1    7675 1400
	-1   0    0    1   
$EndComp
$Comp
...
$Comp
L MCU_Microchip_ATtiny:ATtiny1616-M U2
U 1 1 5EA335CD
P 5000 2200
F 0 "U2" H 5000 3278 50  0000 C CNN
F 1 "ATtiny1616-M" H 5000 3188 50  0000 C CNN
F 2 "Package_DFN_QFN:VQFN-20-1EP_3x3mm_P0.4mm_EP1.7x1.7mm" H 5000 2200 50  0001 C CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/ATtiny3216_ATtiny1616-data-sheet-40001997B.pdf" H 5000 2200 50  0001 C CNN
	1    5000 2200
	1    0    0    -1  
$EndComp
...
U 1 1 5EA8A864
P 1425 4125
F 0 "J1" H 1504 4122 50  0000 L CNN
F 1 "Conn_01x11" H 1504 4077 50  0001 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x11_P2.54mm_Vertical" H 1425 4125 50  0001 C CNN
...
U 1 1 5EA95CE5
P 1850 4125
F 0 "J2" H 1929 4122 50  0000 L CNN
F 1 "Conn_01x11" H 1929 4077 50  0001 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x11_P2.54mm_Vertical" H 1850 4125 50  0001 C CNN
F 3 "~" H 1850 4125 50  0001 C CNN
	1    1850 4125
	-1   0    0    -1  
$EndComp
Text GLabel 2050 4625 2    50   Input ~ 0
PB4
Text GLabel 1225 4625 0    50   Input ~ 0
PB5
Text GLabel 2050 4525 2    50   Input ~ 0
RXD
Text GLabel 2050 4325 2    50   Input ~ 0
PB1
Text GLabel 2050 4125 2    50   Input ~ 0
PC0
Text GLabel 2050 4025 2    50   Input ~ 0
PC1
Text GLabel 2050 3925 2    50   Input ~ 0
PC2
Text GLabel 2050 3825 2    50   Input ~ 0
PC3
$Comp
L Device:C C3
U 1 1 5EB87C2C
